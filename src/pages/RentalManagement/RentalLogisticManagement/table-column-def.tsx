...
import { LogisticAddRemoveCell, LogisticSubQuantityCell } from './table-row-actions';
...
export function createLogisticEquipmentColumns(options?: { showLensType?: boolean }): ColumnDef<MainEquipment, any>[] {
    ...
    return [
        ...
        columnHelper.display({
            id: 'action',
            header: '',
            cell: ({ row }) => <LogisticAddRemoveCell equipmentId={row.original.mainEquipmentId} />,
        }),
    ];
}
...
export function createLogisticSubEquipmentColumns(): ColumnDef<SubEquipment, any>[] {
    return [
