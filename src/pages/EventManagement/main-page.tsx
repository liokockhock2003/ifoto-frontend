...
function EventManagementContent() {
    const { events, isEventCommittee, isLoading, isError, error, refetch } = useEventManagementContext();
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-xl font-semibold tracking-tight text-primary">
                        {isEventCommittee ? 'Equipment Requests' : 'Event Management'}
                    </h1>
                    <p className="text-sm text-muted-foreground">
                        {isEventCommittee
                            ? 'Select an event to request equipment for'
